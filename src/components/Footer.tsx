    ...
    <footer className="relative w-full overflow-hidden bg-background pt-32">
      ...
      {pathname === "/" && (
        <div className="container relative z-10 mx-auto px-6 text-center">
          ...
          >
            <h2 className="font-display text-4xl font-black uppercase tracking-tight text-white sm:text-7xl lg:text-8xl break-words">
              Stop Leaving <br /> <span className="text-accent">Views</span> on the Table.
            </h2>
            <div className="mt-12 flex justify-center">
              <MagneticWrapper strength={0.1}>
                <Link href="/contact" className="inline-flex items-center justify-center rounded-full border-4 border-white bg-white px-6 sm:px-10 h-16 font-display text-lg sm:text-xl font-black uppercase tracking-widest text-accent transition-transform hover:scale-105 hover:shadow-[6px_6px_0px_0px_var(--border)]" data-cursor-hover="true">
      ...
      <div className="container relative z-10 mx-auto mt-20 px-6 pb-12">
        <div className="flex flex-col items-center justify-between gap-8 border-t border-border pt-12 md:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm font-medium uppercase tracking-wider text-muted-foreground">
            ...
            <MagneticWrapper strength={0.2}><Link href="/blog" className="transition-colors hover:text-foreground inline-block">Who We Help</Link></MagneticWrapper>
          </div>
