    ...
    <section className="relative w-full bg-neutral-950 py-32">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <motion.div
          ...
          className="mt-16 rounded-3xl border border-white/5 bg-black/40 p-8 shadow-2xl backdrop-blur-md sm:p-12"
        >
          <div className="flex flex-col gap-12 md:flex-row md:items-center md:gap-16">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="h-2 w-full cursor-pointer appearance-none rounded-full bg-neutral-800 accent-accent"
              />
