          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-8">
            <div className="rounded-3xl border-4 border-border bg-foreground p-10 shadow-[8px_8px_0px_0px_var(--border)]">
              ...
              <div className="flex flex-col gap-6">
                <a href="mailto:scale@clipupmedia.com" className="group flex items-center justify-between rounded-xl border-2 border-border bg-background p-4 sm:p-6 transition-transform hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_var(--accent)] gap-4">
                  <div className="flex items-center gap-4 min-w-0">
                    <Mail className="h-6 w-6 sm:h-8 sm:w-8 shrink-0 text-muted-foreground group-hover:text-accent transition-colors" />
                    <p className="font-display text-base sm:text-lg md:text-xl font-bold text-foreground group-hover:text-accent transition-colors break-all">scale@clipupmedia.com</p>
                  </div>
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full bg-accent text-accent-foreground border-2 border-border font-bold">
                    →
                  </div>
                </a>

                <a href="https://wa.me/917411486296?text=Hey%20im%20looking%20to%20scale%20and%20work%20together" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-between rounded-xl border-2 border-border bg-background p-4 sm:p-6 transition-transform hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_var(--accent)] gap-4">
                  <div className="min-w-0">
                    <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1">WhatsApp</p>
                    <p className="font-display text-base sm:text-lg md:text-xl font-bold text-foreground group-hover:text-accent transition-colors break-all">+91 7411486296</p>
                  </div>
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white border-2 border-border font-bold">
                ...
                <a href="tel:+917411486296" className="group flex items-center justify-between rounded-xl border-2 border-border bg-background p-4 sm:p-6 transition-transform hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_var(--accent)] gap-4">
                  <div className="min-w-0">
                    <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-1">Call Us Directly</p>
                    <p className="font-display text-base sm:text-lg md:text-xl font-bold text-foreground group-hover:text-accent transition-colors break-all">+91 7411486296</p>
                  </div>
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-full bg-foreground text-background border-2 border-border font-bold">
